...
/**
    ...
    This module supports the following parameter IDs:
     - #US_PARAM_ID_SYNC_GESTURE_ALGO_CONFIG
...
*/
#define US_SYNC_GESTURE_LIB_MODULE_ID                                0x00012733

/**
    ID of the parameter used by #US_SYNC_GESTURE_LIB_MODULE_ID
    to configure the Sync Gesture library. Both
    SET_PARAM and GET_PARAM commands can
    use this parameter ID.
*/
#define US_PARAM_ID_SYNC_GESTURE_ALGO_CONFIG                         0x00012734
