...
static boolean mct_pipeline_populate_query_cap_buffer(mct_pipeline_t *pipeline)
{
  ...
  hal_data->padding_info.width_padding  = CAM_PAD_TO_64;
  hal_data->padding_info.height_padding = CAM_PAD_TO_64;
  hal_data->padding_info.plane_padding  = CAM_PAD_TO_64;
  ...
  int supported_effect_cnt = hal_data->supported_effects_cnt;
