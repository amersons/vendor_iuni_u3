     ...
     */
       ...
       */
        ...
        */
         ...
         * Constraints: Should be valid algo type.
         */
        AF_EXHAUSTIVE_SEARCH,//AF_CONTINUOUS_SEARCH,
          ...
          /* damping[MOVE_NEAR] */
          {
            /* scenario 1 */
            {
              /* region 1 */
              {
                .damping_step = 0x1FF,
                .damping_delay = 7000,
                .hw_params = 0x00000400,//0x0000000C,  //gionee chenqiang note : the bit-11 be better to fixd to 1 
          ...
          ,{
            /* scenario 2 */
            {
              /* region 1 */
              {
                .damping_step = 0x1FF,
                .damping_delay = 7000,
                .hw_params = 0x00000400,//0x0000000C,
              },
              /* region 2 */
              {
                .damping_step = 0x1FF,
                .damping_delay = 4500,
                .hw_params = 0x00000400,//0x00000009,
              },
            },
          },
        },
          ...
          /* damping[MOVE_FAR] */
          {
            /* scenario 1 */
            {
              ...
              /* region 2 */
              {
                .damping_step = 0x1FF,
                .damping_delay = 4500,
                .hw_params = 0x00000400,//0x0000007,
              },
            },
          },
          {
            /* scenario 2 */
            {
              ...
              /* region 2 */
              {
                .damping_step = 0x1FF,
                .damping_delay = 12000,
                .hw_params = 0x00000400,//0x0000000E,
              },
            },
          },
          {
            /* scenario 3 */
            {
              ...
              /* region 2 */
              {
                .damping_step = 0x1FF,
                .damping_delay = 15000,
                .hw_params = 0x00000400,//0x00000004,
              },
            },
          },
        },
