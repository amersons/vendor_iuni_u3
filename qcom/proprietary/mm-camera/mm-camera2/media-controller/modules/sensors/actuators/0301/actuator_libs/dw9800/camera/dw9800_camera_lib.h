...
============================================================================*/
  {
     ...
     */
       ...
       */
        ...
        */
         ...
         */
        2,     // 2 Javan Change The second time is 4
      ...
      /* af_tuning_exhaustive_t */
      {
         ...
         *   position.
         */
        4,    // 4 Javan Change  2 the second time
         ...
         * Effect:
         */
        0.99f,//0.97f,   // 0.97f  Javan Change  the second time is 0.87f
    ...
    /* actuator_params_t */
    {
      ...
      /* msm_actuator_reg_tbl_t */
      {
        ...
        /* msm_actuator_reg_params_t */
        {
          ...
          {MSM_ACTUATOR_WRITE_DAC, 0x00000000, 0x03, 0, 0},
      ...
      /* init_settings */
      {
		  {0x02, 0x02}, /* Ringing setting On */
		  {0x06, 0x40}, /* DLC and MCLK[1:0] setting */
		  {0x07, 0x79}, /* T_SRC[4:0] setting */
		 // {0xDC, 0x51}, /* Ringing setting OFF */
		  //{0x01, 0x39}, // Linear mode, SAC3 mode
		  //{0x05, 0x7b}, // Tvib=12.2ms
    ...
    /* actuator_tuned_params_t */
    {
      ...
      /* region_params */
      {
        ...
        {
          .step_bound = {3, 0},
          .code_per_step = 8,   // 72 Javan Change
        },
        /* Region 2 */
        {
          .step_bound = {49, 3},
        ...
        /* damping */
        {
          /* damping[MOVE_NEAR] */
          {
            /* scenario 1 */
            {
              /* region 1 */
              {
                .damping_step = 0x3FF,  // 0x1FF Javan Change
                .damping_delay = 7000,
