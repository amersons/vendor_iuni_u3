GN_SUNNY_OV4688_SENSOR_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#                      Make the shared library (libchromatix_gn_sunny_ov4688_preview)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(GN_SUNNY_OV4688_SENSOR_LIBS_PATH)
...
LOCAL_SRC_FILES:= gn_sunny_ov4688_lib.c
LOCAL_MODULE           := libmmcamera_gn_sunny_ov4688
