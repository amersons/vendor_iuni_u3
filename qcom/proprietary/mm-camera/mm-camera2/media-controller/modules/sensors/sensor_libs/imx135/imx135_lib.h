...
#define ENABLE_RES0_2VFE_REGISTER_SETTINGS 0
...
static struct msm_camera_i2c_reg_array res0_1vfe_reg_array[] = {
	  /* full size resolution (Snapshot) 22fps */
	/* Clock Setting */
	{ 0x011E, 0x18  },					 
	{ 0x011F, 0x00  },					 
	{ 0x0301, 0x05  },					 
...
static struct msm_camera_i2c_reg_array res2_reg_array[] = {
	/* half size resolution @ 29.99 fps */
...
//1080P setting
static struct msm_camera_i2c_reg_array res8_1vfe_reg_array[] = {
	//1080P setting 30.03
	/* Clock Setting */
	{ 0x011E, 0x18 },					 
	{ 0x011F, 0x00 },					 
