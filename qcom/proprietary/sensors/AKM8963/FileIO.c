/******************************************************************************
 *
 * $Id: FileIO.c 600 2012-04-16 05:04:18Z yamada.rj $
 *
 * -- Copyright Notice --
 *
 ...
 */
int16 LoadParameters(const char* path, AK8963PRMS * prms)
{
	int16 tmp, ret;
	int16 i;
	FILE *fp = NULL;
 ...
 */
int16 SaveParameters(const char* path, AK8963PRMS * prms)
{
	int16 ret = 1;
	int16 i;
	FILE *fp;
