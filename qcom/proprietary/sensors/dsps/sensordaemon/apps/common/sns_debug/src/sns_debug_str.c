...
//Gionee liujiang 2013-10-22 modify for sensor log start
static log_level_e g_log_level = LOG_LEVEL_INFO; //LOG_LEVEL_WARN;
//Gionee liujiang 2013-10-22 modify for sensor log end
#endif
