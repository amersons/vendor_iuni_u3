...
/* Gionee liuxw 2013-08-17 add for gn_correlative_nv begin */
import com.qualcomm.qcrilhook.QcRilHookCallback;
/* Gionee liuxw 2013-08-17 add for gn_correlative_nv end */
...
/* Gionee liuxw 2013-08-17 modify for gn_correlative_nv begin */
//public class QcNvItems implements IQcNvItems {
public class QcNvItems implements IQcNvItems,QcRilHookCallback{
/* Gionee liuxw 2013-08-17 modify for gn_correlative_nv end */
    ...
    public QcNvItems(Context context) {
        ...
        mQcRilOemHook = new QcRilHook(context,this);
        /* Gionee liuxw 2013-08-17 modify for gn_correlative_nv end */
    }

    /* Gionee liuxw 2013-08-17 add for gn_correlative_nv begin */
	public QcNvItems(Context context,QcRilHookCallback callback){
     super();
        vLog("QcNvItems instance created.");

        mQcRilOemHook = new QcRilHook(context,callback);
	}
    ...
    //EGMR NV9000
    public String getEgmrResult() throws IOException {
        vLog("getEgmrResult()");
        NvEgmrType o = new NvEgmrType(doNvRead(QcNvItemIds.NV_EGMR_I));
        vLog(o.toDebugString());
        return o.getNvEgmrNumber();
    }

    public void setEgmrResult(String egmrset) throws IOException {
         vLog("setEgmrResult()");
 
          NvEgmrType o = new NvEgmrType();
          o.setNvEgmrNumber(egmrset);
		 
          vLog(o.toDebugString());
          doNvWrite(o, QcNvItemIds.NV_EGMR_I);
    }

    //GHDVER NV9001
    public String getGhdverResult() throws IOException {
        vLog("getGhdverResult()");
        NvGhdverType o = new NvGhdverType(doNvRead(QcNvItemIds.NV_GHDVER_I));
        vLog(o.toDebugString());
        return o.getNvGhdverNumber();
    }

    public void setGhdverResult(String ghdverset) throws IOException {
         vLog("setGhdverResult()");
 
          NvGhdverType o = new NvGhdverType();
          o.setNvGhdverNumber(ghdverset);
		 
          vLog(o.toDebugString());
          doNvWrite(o, QcNvItemIds.NV_GHDVER_I);
    }
	
    //factory set NV9004
    public String getFactoryResult() throws IOException {
        vLog("getFactoryResult()");
        NvFactoryType o = new NvFactoryType(doNvRead(QcNvItemIds.NV_FACTORY_SET_I));
        vLog(o.toDebugString());
        return o.getNvFactoryNumber();
    }

    public void setFactoryResult(String factoryset) throws IOException {
         vLog("setFactoryResult()");
 
          NvFactoryType o = new NvFactoryType();
          o.setNvFactoryNumber(factoryset);
		 
          vLog(o.toDebugString());
          doNvWrite(o, QcNvItemIds.NV_FACTORY_SET_I);
    }

    // wifidls_info NV9005
    public NvWifiDLSType getWifiDLSResult() throws IOException {
        vLog("getWifiDLSResult()");

        NvWifiDLSType r = new NvWifiDLSType(doNvRead(QcNvItemIds.NV_WIFIDLS_INFO_I));
        vLog(r.toDebugString());
		
        byte hFlag = PrimitiveParser.parseByte(r.mFlag);
        int hDls = PrimitiveParser.parseInt(r.mDls);
		
        return new NvWifiDLSType(hFlag,hDls);
    }

    public void setWifiDLSResult(byte mFlag,int mDls) throws IOException {
        vLog("setWifiDLSResult()");

        NvWifiDLSType o = new NvWifiDLSType();
        try {
            o.mFlag= mFlag;
            o.mDls = mDls;
        } catch (NumberFormatException e) {
        ...
        doNvWrite(o, QcNvItemIds.NV_WIFIDLS_INFO_I);
    }
    /* Gionee liuxw 2013-07-13 add for gn_correlative_nv end */
    /* Gionee liuxw 2014-07-12 add for sglte open market begin */
    //OPEN_MARKET_FLAG  NV9007
    public byte getOpenMarketFlag() throws IOException{
        vLog("getOpenMarketFlag()");
        NvByte o = new NvByte(doNvRead(QcNvItemIds.NV_OPEN_MARKET_FLAG_I));
        vLog(o.toDebugString());
        return o.mVal;

    }

    public void setOpenMarketFlag(byte open_market_flag) throws IOException{
        vLog("setOpenMarketFlag()");

        NvByte o = new NvByte();
        o.mVal = open_market_flag;

        doNvWrite(o, QcNvItemIds.NV_OPEN_MARKET_FLAG_I);
    }
    /* Gionee liuxw 2014-07-12 add for sglte open market end */
    //Gionee <bug> <jiaoyuan> <20131130> add for CR00960202 begin
    public void dispose() {
        if (mQcRilOemHook != null) {
            vLog("mQcRilOemHook.dispose()");
