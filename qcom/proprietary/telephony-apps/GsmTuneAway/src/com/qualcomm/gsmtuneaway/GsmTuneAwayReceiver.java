...
public class GsmTuneAwayReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        mContext = MSimPhoneFactory.getPhone(DEFAULT_SUBSCRIPTION).getContext();
    ...
    private int getPrefNetworkTypeFromDB(int sub) {
        int nwMode;
        try {
            ...
            nwMode = Phone.NT_MODE_WCDMA_PREF;
        }
        log("getPrefNetworkTypeFromDB network mode: " + nwMode + " for subscription " + sub);
        return nwMode;
    }
