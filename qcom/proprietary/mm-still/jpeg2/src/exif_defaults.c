...
//Gionee <zhuangxiaojiani> <2014-08-19> modify for CR01342265 begin
#ifdef ORIGINAL_VERSION
#else
#define CUSTOM_EXIF_STRING_MAKE		"IUNI"//CONFIG_GN_PRODUCT_BRAND
#define CUSTOM_EXIF_STRING_MODEL 	"U3 Camera"//(CONFIG_GN_PRODUCT_BRAND " " CONFIG_GN_PRODUCT_MODEL " camera")
#endif
//Gionee <zhuangxiaojiani> <2014-08-19> modify for CR01342265 end
